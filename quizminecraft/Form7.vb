Public Class Form7
    ...
    Private Sub btn_redstone_Click(sender As Object, e As EventArgs) Handles btn_redstone.Click
        If sele = 1 Then
            picbox_challe.BackgroundImage = My.Resources.reds2_reds
    ...
    Private Sub btn_pedra_Click(sender As Object, e As EventArgs) Handles btn_pedra.Click
        If sele = 1 Then
            picbox_challe.BackgroundImage = My.Resources.reds2_pedra
            btn_select.Visible = False
            Timer1.Enabled = True
            timer_crono.Enabled = False
            sele = 0
        ...
        End If
    End Sub
    Private Sub btn_tnt_Click(sender As Object, e As EventArgs) Handles btn_tnt.Click
        If sele = 1 Then
            picbox_challe.BackgroundImage = My.Resources.reds2_tnt
            btn_select.Visible = False
            Timer2.Enabled = True
            timer_crono.Enabled = False
            sele = 0
