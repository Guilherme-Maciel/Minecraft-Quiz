Public Class Form5
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btn_ok.Click
        ...
        If objeto = 3 And ordem = 3 Then
            If picbox_objeto2.Left = 293 And (picbox_objeto3.Top = 92 And (picbox_objeto3.Left = 293)) Then
                pontos_craft = pontos_craft + 1
                Form6.Show()

                Me.Close()

            ElseIf picbox_objeto2.Left = 435 And (picbox_objeto3.Top = 92 And (picbox_objeto3.Left = 435)) Then
                pontos_craft = pontos_craft + 1
                Form6.Show()
                Me.Close()

            ElseIf picbox_objeto2.Left = 577 And (picbox_objeto3.Top = 92 And (picbox_objeto3.Left = 577)) Then
                pontos_craft = pontos_craft + 1
                Form6.Show()
                Me.Close()
