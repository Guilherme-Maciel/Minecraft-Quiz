Public Class Form3
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btn_ok.Click
        If objeto = 1 And ordem = 1 Then
            If picbox_objeto1.Top = 234 And (picbox_objeto1.Left = 435 Or picbox_objeto1.Left = 293 Or picbox_objeto1.Left = 577) Then
                picbox_objeto2.Visible = True
                objeto = 2

            ElseIf picbox_objeto1.Top = 376 And (picbox_objeto1.Left = 435 Or picbox_objeto1.Left = 293 Or picbox_objeto1.Left = 577) Then
                picbox_objeto2.Visible = True
                objeto = 2
        ...
        If objeto = 2 And ordem = 2 Then
            If (picbox_objeto1.Top = 234 And picbox_objeto1.Left = 293) And (picbox_objeto2.Top = 376 And picbox_objeto2.Left = 293) Then
                picbox_objeto3.Visible = True
                objeto = 3

            ElseIf (picbox_objeto1.Top = 234 And picbox_objeto1.Left = 435) And (picbox_objeto2.Top = 376 And picbox_objeto2.Left = 435) Then
                picbox_objeto3.Visible = True
                objeto = 3

            ElseIf (picbox_objeto1.Top = 234 And picbox_objeto1.Left = 577) And (picbox_objeto2.Top = 376 And picbox_objeto2.Left = 577) Then
                picbox_objeto3.Visible = True
                objeto = 3

            ElseIf (picbox_objeto1.Top = 376 And picbox_objeto1.Left = 293) And (picbox_objeto2.Top = 234 And picbox_objeto2.Left = 293) Then
                picbox_objeto3.Visible = True
                objeto = 3

            ElseIf (picbox_objeto1.Top = 376 And picbox_objeto1.Left = 435) And (picbox_objeto2.Top = 234 And picbox_objeto2.Left = 435) Then
                picbox_objeto3.Visible = True
                objeto = 3

            ElseIf (picbox_objeto1.Top = 376 And picbox_objeto1.Left = 577) And (picbox_objeto2.Top = 234 And picbox_objeto2.Left = 577) Then
                picbox_objeto3.Visible = True
                objeto = 3
        ...
        If objeto = 3 And ordem = 3 Then
            If picbox_objeto2.Left = 293 And (picbox_objeto3.Top = 92 And (picbox_objeto3.Left = 293 Or picbox_objeto3.Left = 435)) Then
                picbox_objeto4.Visible = True
                objeto = 4

            ElseIf picbox_objeto2.Left = 435 And (picbox_objeto3.Top = 92 And (picbox_objeto3.Left = 435 Or picbox_objeto3.Left = 293 Or picbox_objeto3.Left = 577)) Then
                picbox_objeto4.Visible = True
                objeto = 4

            ElseIf picbox_objeto2.Left = 577 And (picbox_objeto3.Top = 92 And (picbox_objeto3.Left = 577 Or picbox_objeto3.Left = 435)) Then
                picbox_objeto4.Visible = True
                objeto = 4

            End If
        End If
        If objeto = 4 And ordem = 4 Then
            If (picbox_objeto3.Left = 293 Or picbox_objeto3.Left = 577) And picbox_objeto4.Top = 92 And picbox_objeto4.Left = 435 Then
                pontos_craft = pontos_craft + 1
                Form4.Show()
                Me.Close()

            ElseIf picbox_objeto3.Left = 435 And picbox_objeto4.Top = 92 And (picbox_objeto4.Left = 577 Or picbox_objeto4.Left = 293) Then
                pontos_craft = pontos_craft + 1
                Form4.Show()
                Me.Close()
